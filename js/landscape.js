(function() {
  ...
  /*更新方向函数，如果为-90，则表示手机处于横屏状态，显示横屏提示，默认情况隐藏横屏提示*/
  ...
  /*初始化：创建横屏提示元素，在窗口方向改变时*/
  function initOrientationChange() {
    // 创建横屏提示元素;
    createLandscapeTip();
    // 触发第一次更新方向函数，默认情况先先隐藏横屏提示;
    updateOrientation();
    // 绑定窗口方向改变事件，在手机方向改变时触发;
    window.addEventListener('orientationchange', updateOrientation, false);
    // 在横屏提示元素上绑定触摸事件，阻止默认行为？什么行为
